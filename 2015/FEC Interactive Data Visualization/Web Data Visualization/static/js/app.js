...
DashboardController.prototype.filterTransactionsByMapSelection = function () {
    ...
    //debugger
    var that = this;
   // console.log(this.usCashMap[0]);
 //   console.log(this.allTransactions.filter(function (el) { return that.usCashMap.hasStateInSelection(el.state)}));
    

    return this.allTransactions.filter(function (el) { return that.usCashMap.hasStateInSelection(el.state)});
};
